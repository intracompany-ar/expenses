...
useHead({
	...
	meta: [
		{ name: 'description', content: 'Aplicación para llevar registro de ingresos y egeresos de tu vida cotidianda de forma simplificada. Un buen control de tu contabilidad es la clave del éxito financiero.' }
	],
